...
FSharpMap.prototype.GetHashCode = function () {
  ...
  while (e$$1.MoveNext()) {
    const activePatternResult3088 = e$$1.Current;
    res$$3 = combineHash(res$$3, structuralHash(activePatternResult3088[0]));
    res$$3 = combineHash(res$$3, structuralHash(activePatternResult3088[1]));
  }
