...
import { compare, count as count$$26, addToSet, tryGetValue, comparerFromEqualityComparer, max as max$$1, comparePrimitives } from "./Util.js";
import { createMutable } from "./Map.js";
import { delay, map as map$$1, rangeNumber, iterateIndexed as iterateIndexed$$1, iterate as iterate$$1 } from "./Seq.js";
...
export function groupBy(projection$$2, array$$25, cons$$11, eq$$5) {
  ...
  for (let idx$$3 = 0; idx$$3 <= array$$25.length - 1; idx$$3++) {
    ...
    if (matchValue$$4[0]) {
      ...
      dict$$1.set(key$$1, new List(v, new List()));
      keys.push(key$$1);
    }
  }
  ...
  iterateIndexed$$1(function action(i$$14, key$$2) {
    result$$5[i$$14] = [key$$2, cons$$11.from(dict$$1.get(key$$2)).reverse()];
  }, keys);
  return result$$5;
}
...
export function windowed(windowSize, source$$11) {
  ...
  return ofSeq$$1(delay(function () {
    return map$$1(function (i$$52) {
      return source$$11.slice(i$$52 - windowSize, i$$52 - 1 + 1);
    }, rangeNumber(windowSize, 1, source$$11.length));
  }), Array);
}